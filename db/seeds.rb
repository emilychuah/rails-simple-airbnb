...
Flat.create!(
  name: 'Ravenswood Tiny House',
  address: 'Ravenswood, Victoria, Australia',
  description: 'Located in beautiful Ravenswood, this compact yet contemporary and comfortable tiny house is perfect for those wanting to get away from the hustle and bustle of every day life.',
  price_per_night: 100,
  number_of_guests: 2
)
